                            ...
                            <tr class="table_row">
                                <td class="column-1">
                                    <div class="how-itemcart1">
                                        <img src="{{ url('storage/images/' . $cart->product->image) }}" alt="IMG">
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('update_cart', $cart->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('PUT')
                                        <input type="number" name="quantity" value="{{ $cart->quantity ?? NULL }}" min="1" class="form-control" style="width: 80px;">
                                        <button type="submit" class="btn btn-sm btn-primary mt-1">Update</button>
                                    </form>
                                </td>
                                <td class="column-5">${{ number_format($cart->amount ?? NULL, 0, ',', '.') }}</td>
                            </tr>
                            @endforeach
