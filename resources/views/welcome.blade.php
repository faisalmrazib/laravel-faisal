	...
	<header>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						<a href="{{ route('show_profile') }}" class="flex-c-m trans-04 p-lr-25">
							My Account
						</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu">
								...
								<ul class="sub-menu">
								<li><a href="home-03.html">Homepage 1</a></li>
								</ul>
							</li>
							<li>
		...
		<div class="menu-mobile">
			<ul class="topbar-mobile">
				...
				<li>
					<div class="right-top-bar flex-w h-full">
						<a href="{{ route('show_profile') }}"class="flex-c-m p-lr-10 trans-04">
							My Account
						</a>
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="{{ route('show_cart') }}" class="label1 rs1" data-label1="hot">CART</a>
				</li>
				<li>
					<a href="{{ route('index_order') }}">ORDER</a>
				</li>
